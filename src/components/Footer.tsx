...
export default function Footer() {
  ...
  return (
    <footer className="bg-like-dark text-white pt-20 pb-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center text-center mb-20">
          ...
          <div className="w-full max-w-sm">
            <a 
              ...
              className="block w-full py-6 bg-like-red hover:bg-like-red-dark text-white rounded-2xl font-black text-xl tracking-widest uppercase transition-all shadow-2xl shadow-like-red/40 hover:scale-105"
            >
              FAÇA PARTE DO TIME
            </a>
        ...
        <div className="pt-10 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-[10px] text-gray-500 font-bold uppercase tracking-widest text-center md:text-left">
            © {currentYear} LIKE BRASIL PERFUMES E COSMÉTICOS. TODOS OS DIREITOS RESERVADOS. - Criado por @onathanoficial
          </p>
